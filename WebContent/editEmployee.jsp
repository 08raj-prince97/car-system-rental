...
<body>
	...
	<form action="UpdateEmployee?id=${editEmployee[0].id}" method="post">
		<h6 class="mt-5" style="text-align: center;">Update Employee Details</h6>
		<hr>
		...
		<div class="container mt-4">
			...
			<div class="form-group">
				<label for="exampleInputMobile">EMAIL*</label> <input type="email"
					...
					placeholder="Enter email" required name="email" value="${editEmployee[0].email}">
			</div>

			<div class="form-group">
				<label for="exampleInputMobile">MOBILE*</label> <input type="text"
					class="form-control" id="exampleInputMobile"
					placeholder="Enter mobile" required name="mobile" value="${editEmployee[0].mobile}">
			</div>
