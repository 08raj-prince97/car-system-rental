...
<body>
	...
	<div class="container mt-4">
		<h3 class="" style="text-align: center">Forget Password</h3>

		<form action="Register" method="post" oninput='password2.setCustomValidity(password2.value != password1.value ? "Passwords do not match." : "")'>
