...
<body>
	...
	<form action="UpdateUserDetails2?id=${editUser[0].id}" method="post">
		<c:choose>
		...
		<div class="container mt-4">
			...
			<div class="form-group">
				<label for="exampleInputName">NAME*</label> <input type="text"
					...
					required name="name" value="${editUser[0].name}">
			</div>

			<div class="form-group">
				<label>EMAIL*</label> <input type="email" class="form-control"
					id="exampleInputName" value="${editUser[0].email}" disabled>
			</div>
			...
			<div class="form-group">
				<label for="exampleInputCity">CITY*</label> <input type="text"
					...
					required name="city" value="${editUser[0].city}">
			</div>
