...
public class SearchCarDao {
	...
	public ArrayList carDetails(double from_date, double to_date) {
		
		String sql ="SELECT * FROM cars WHERE id NOT IN (SELECT car_id FROM bookingdetails WHERE from_date BETWEEN "+from_date+" AND "+to_date+" OR to_date BETWEEN "+from_date+" AND "+to_date+")";
